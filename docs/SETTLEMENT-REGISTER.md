...
Last reconciled against the tree: migration `0041` (payslip delivery), 1,566 tests
(710 domain · 602 db · 216 api · 21 worker · 17 contracts), plus one Playwright browser
...
register, the month computed and confirmed into the books, the CP39 downloaded, and every
payslip for the month downloaded as one file under the name the server gave it.
