...
Last reconciled against the tree: migration `0040` (pay runs), 1,561 tests
(710 domain · 599 db · 214 api · 21 worker · 17 contracts), plus one Playwright browser
...
register, the month computed and confirmed into the books, and the CP39 downloaded.
